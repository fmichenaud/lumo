...
/// Section Intégrations : les sources intégrées (stats du Mac, crypto) et les connecteurs
/// vers n'importe quelle API, affichés en direct sur l'écran.
        ...
        VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 12) {
                ...
                if live.cryptoOn, let p = live.cryptoPrice {
                    Text("\(formatPrice(p))\(live.currencySymbol)")
